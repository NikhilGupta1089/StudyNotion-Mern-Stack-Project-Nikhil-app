...
const LearningGridArray = [
    ...
    },
    {
        ...
        description:
         `Save time and money! The Belajar curriculum is made to be easier to understand and in 
...
const LearningGrid = () => {
  return (
    <div className='grid mx-auto grid-cols-1 lg:grid-cols-4 mb-10 p-5 lg:w-fit text-white'>
      {
