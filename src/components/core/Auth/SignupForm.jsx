        ...
        <div>
            ...
            <form 
             ...
             className="flex w-full flex-col gap-y-4">
                   ...
                   <div className="flex gap-x-4">
                    <lable className="relative">
                        ...
                        <input
                            ...
                            className="w-full rounded-[0.5rem] bg-richblue-800 p-[12px] pr-10 text-richblack-5"
                        />
                        <span
                ...
                <button
                  type="submit"
                  className="mt-6 rounded-[8px] bg-yellow-50 py-[8px] px-[12px] font-medium text-caribbeangreen-900"
                  >
                    Create Account
                </button>
