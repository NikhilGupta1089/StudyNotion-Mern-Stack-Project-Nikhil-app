...
const MyProfile = () => {
  ...
  return (
    <div className="text-white">
       ...
       <h1 className="mb-14 text-3xl font-medium text-richblack-5 text-start">
           My Profile
       </h1>

       {/* Section 1 */}
       <div className="flex flex-col sm:flex-row gap-4 lg:gap-0 items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
       ...
       {/* Section 2 */}
       <div className="my-10 flex flex-col gap-y-10 rounded-md border-richblack-700 bg-richblack-800 p-8 px-12">
       ...
       <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
          <div className="flex justify-between w-full items-center lg:gap-0 gap-10">
             <p className="text-lg font-semibold text-richblack-5">
               Personal Details
            </p>
             <IconBtn
