  ...
  return (
    <div>
       ...
       <section className='bg-richblack-700'>
         <div className='relative w-11/12 mx-auto max-w-maxContent flex flex-col gap-10 justify-between text-center text-white'>
             <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                Driving Innovation in Online Education for a
                <HighlightText text={"Brighter Future"}/>
                <p className='mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>
                Studynotion is at the forefront of driving innovation in online education.
                 We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
             </header>
               <div className="sm:h-[70px] lg:h-[150px]"></div>
             <div className='absolute bottom-0 left-[50%] grid grid-cols-3 gap-3 lg:gap-5 w-[100%] translate-x-[-50%] translate-y-[30%]'>
       ...
       {/* Section 2 */}
       <section className='border-b border-richblack-700 mt-[140px]'>
          <div className='w-11/12 mx-auto max-w-maxContent flex flex-col gap-10 justify-between text-richblack-500 '>
              <Quote className="h-[100px]"/>
          </div>
       </section>
             ...
             <div className='flex flex-col lg:flex-row gap-10 items-center justify-between'>
               {/* founding story left box */}
                <div className='flex flex-col gap-10 lg:w-[50%] my-24'>
                   ...
                   <p className="text-base font-medium text-richblack-300 lg:w-[95%]">Our e-learning platform was born out of a shared vision and passion 
                   for transforming education. It all began with a group of educators, technologists, 
                   ...
                   <p className="text-base font-medium text-richblack-300 lg:w-[95%]">As experienced educators ourselves, we witnessed firsthand the limitations and 
                   challenges of traditional education systems. We believed that education should not
                    ...
                    all walks of life to unlock their full potential.</p>
                </div>
       ...
       {/* Section 5 */}
       <section className='w-11/12 mx-auto mt-20 max-w-maxContent flex flex-col justify-between gap-10 text-white'>
          <LearningGrid/>
          <ContactFormSection/>
       </section>
