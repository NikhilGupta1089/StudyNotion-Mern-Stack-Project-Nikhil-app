...
const Home = () => {
  return (
    <div>
       ...
       {/* Section 1 */}
       <div className='relative mx-auto flex flex-col items-center w-11/12 max-w-maxContent
       ...
       <div className='bg-pure-greys-5 text-richblack-700'>
         ...
         <div className='w-11/12 max-w-maxContent flex flex-col mx-auto gap-8 justify-between items-center'>

              <div className='flex flex-col lg:flex-row gap-7 lg:gap-0 mb-10 mt-[-100px] justify-between lg:mt-20'>
