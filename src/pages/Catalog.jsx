...
const Catalog = () => {
  ...
  return (
    <div className="box-content bg-richblack-800 px-4">
        ...
        <div className="flex flex-col mx-auto min-h-[260px] max-w-maxContentTab lg:max-w-maxContent justify-center gap-4">
        ...
        <div>
            ...
            {/* Section 1 */}
            <div className="w-full max-w-maxContentTab lg:max-w-maxContent box-content ">
                <div className="section_heading">Courses to get you started</div>
                <div className='my-4 flex border-b border-b-richblack-600 text-sm'>
                    <p className={`px-4 py-2 ${active === 1 ? "border-b border-b-yellow-25 text-yellow-25"
                      : "text-richblack-50"} cursor-pointer`}
                      onClick={() => setActive(1)}
                      >
                        Most Popular
                    </p>
                    <p className={`px-4 py-2 ${active === 2 ? "border-b border-b-yellow-25 text-yellow-25"
                      : "text-richblack-50"} cursor-pointer`}
                      onClick={() => setActive(2)}
                      >
                         New
